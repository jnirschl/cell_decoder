#  cell_decoder/models/GoogLeNet_BN_inception.py
#
...
# ======================================================================
'''
Creates a convolutional neural network with the GoogLeNet 
BN Inception architecture.
...
##
raise RuntimeError('Function not yet complete')
